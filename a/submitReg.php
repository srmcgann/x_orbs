<?php 
  ...
  $available=str_replace(chr(10),'',file_get_contents($baseURL . "/checkUserNameAvailability.php?userName=".urlencode($userName)))==="true";
  if($available && $password){
    ...
    echo json_encode([$available,$baseURL . "/checkUserNameAvailability.php?userName=".$userName,'username unavailable or password not provided!']);
  }
?>
